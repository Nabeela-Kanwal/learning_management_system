     ...
     <div class="category-wrapper mt-30px">
         <div class="row">
             ...
             <div class="col-lg-4 responsive-column-half">
                 <div class="category-item">
                     <img class="cat__img lazy" src="{{ asset('frontend/images/img-loading.png') }}"
                         data-src="images/img2.jpg" alt="Category image">
                     <div class="category-content">
                         <div class="category-inner">
             ...
             <div class="col-lg-4 responsive-column-half">
                 <div class="category-item">
                     <img class="cat__img lazy" src="{{ asset('frontend/images/img-loading.png') }}"
                         data-src="images/img3.jpg" alt="Category image">
                     <div class="category-content">
                         <div class="category-inner">
             ...
             <div class="col-lg-4 responsive-column-half">
                 <div class="category-item">
                     <img class="cat__img lazy" src="{{ asset('frontend/images/img-loading.png') }}"
                         data-src="images/img4.jpg" alt="Category image">
                     <div class="category-content">
                         <div class="category-inner">
             ...
             <div class="col-lg-4 responsive-column-half">
                 <div class="category-item">
                     <img class="cat__img lazy" src="{{ asset('frontend/images/img-loading.png') }}"
                         data-src="images/img5.jpg" alt="Category image">
                     <div class="category-content">
                         <div class="category-inner">
             ...
             <div class="col-lg-4 responsive-column-half">
                 <div class="category-item">
                     <img class="cat__img lazy" src="{{ asset('frontend/images/img-loading.png') }}"
                         data-src="images/img6.jpg" alt="Category image">
                     <div class="category-content">
                         <div class="category-inner">
