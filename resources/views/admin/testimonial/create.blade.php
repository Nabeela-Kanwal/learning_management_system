                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" name="name" id="name" class="form-control" value="{{ old('name', '') }}" maxlength="120" required placeholder="Name" />
                                        </div>
                                        @error('name')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" name="role" id="role" class="form-control" value="{{ old('role', 'Student') }}" maxlength="120" required placeholder="Role" />
                                        </div>
                                        @error('role')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <textarea name="quote" id="quote" class="form-control" rows="4" maxlength="2000" required placeholder="Quote">{{ old('quote', '') }}</textarea>
                                        </div>
                                        @error('quote')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="number" name="rating" id="rating" class="form-control" value="{{ old('rating', '5') }}" min="1" max="5" step="1" required placeholder="Rating" />
                                        </div>
                                        @error('rating')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="number" name="sort_order" id="sort_order" class="form-control" value="{{ old('sort_order', '0') }}" min="0" max="999999" step="1" placeholder="Sort Order" />
                                        </div>
                                        @error('sort_order')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
