            ...
            <div class="row">
                <div class="col-xxl">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form novalidate action="{{ route('admin.blog.store') }}" method="POST"
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" name="title" class="form-control"
                                                value="{{ old('title') }}" placeholder="Blog title" required />
                                        </div>
                                        @error('title')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" name="slug" class="form-control"
                                                value="{{ old('slug') }}" placeholder="Optional custom slug" />
                                        </div>
                                        @error('slug')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <textarea name="short_description" class="form-control" rows="3" placeholder="Short summary">{{ old('short_description') }}</textarea>
                                        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <textarea name="description" class="form-control" rows="8" placeholder="Blog content" required>{{ old('description') }}</textarea>
                                        </div>
                                        @error('description')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <x-logos.status name="status" value="1" />
                                    </div>
                                </div>
